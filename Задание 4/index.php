  ...
  try{
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
      ...
      if ($errors['name']) {
        ...
        // Выводим сообщение.
        $messages[] = '<div class="error_message">Заполните имя.</div>';
      }

      //Ошибка в почте
      if ($errors['email']) {
        setcookie('email_error', '', 100000);
        $messages[] = '<div class="error_message">Заполните почту.</div>';
      }

      //Ошибка в дате
      if ($errors['date']) {
        setcookie('date_error', '', 100000);
        $messages[] = '<div class="error_message">Заполните дату.</div>';
      }
